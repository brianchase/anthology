...
\settowidth\versewidth{\small The Earth waits for her Queen.''}
\page{15}\begin{verse}[\versewidth]
\poke{``}Frailty, thy name is \textsc{Woman}.''\\
\poke{``}The Earth waits for her Queen.''
\end{verse}
...
\settowidth\versewidth{\small The Earth waits for its King?}
...
\settowidth\versewidth{\small Forte Deo doliturus erit, data pr\ae mia nollet,}
\begin{verse}[\versewidth]
...
\settowidth\versewidth{\small Der stets den Hirten gnadig sich bewies.''}
\begin{verse}[\versewidth]
\poke{``}Der stets den Hirten gnadig sich bewies.''
\end{verse}
...
\settowidth\versewidth{\small \vin Must melt all rocks free from their primal pain,}
\begin{verse}[\versewidth]
...
\settowidth\versewidth{\small In whatever hour, in whatever part of the soil,}
\begin{verse}[\versewidth]
\poke{``}Tutti fatti a sembianza d'un Solo,\\
...
\poke{``}All made in the likeness of the One,\\
