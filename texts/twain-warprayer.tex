...
% NOTE: the source has 'them home from the war'
...
\settowidth\versewidth{\small Thunder thy clarion and lightning thy sword!''}
\begin{verse}[\versewidth]
\poke{``}God the all-terrible! Thou who ordainest,\\
