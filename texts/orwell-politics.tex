...
\nfootnote{\fullcite{orwell1946}}

% FIX: perhaps give another round of proofreading

\page{252}Most people who bother with the matter at all would admit
...
like preferring candles to electric light or hansom cabs \page{253} to
...
`(\lnn{1}) I am not, indeed, sure whether it is not true to say that
...
\page{254}`(\lnn{3}) On the one side we have the free personality: by
...
`(\lnn{4}) All the ``best people'' from the gentlemen's clubs, and all
...
\begin{flushright} Communist pamphlet. \end{flushright}

`(\lnn{5}) If a new spirit \textit{is} to be infused into this old
...
something else, or he is almost indifferent as to whether \page{255}
...
\textit{Dying metaphors}. A newly invented metaphor assists thought by
...
\textit{Operators}, or \textit{verbal false limbs}. These save the
...
be subjected to, give \page{256} rise to, give grounds for, have the
...
clandestine, subaqueous} and hundreds \page{257} of others constantly
...
in so far as it signifies \page{258} `something not desirable'. The
...
This is a parody, but not a very gross one. Exhibit (\lnn{3}), above,
...
bread---dissolve into the vague phrases `success or failure \page{259}
...
mental effort, at the cost of leaving your \page{260} meaning vague,
...
Professor Laski (\lnn{1}) uses five negatives in 53 words. One of
...
the general vagueness. Professor Hogben (\lnn{2}) plays ducks and
...
(\lnn{3}), if one takes an uncharitable attitude towards it, is simply
meaningless: probably one could work out its intended meaning by
reading the whole of the article in which it occurs. In (\lnn{4}), the
...
(\lnn{5}), words and meaning have almost parted company. People who
...
Where it is not true, it will generally be found that the \page{261}
...
% NOTE 'in\-de\-fen\-si\-ble'. Putting it in \hyphenation didn't work.
...
things without \page{262} calling up mental pictures of them. Consider
...
political structure \page{263} in such a way as to avoid a
...
having what is called a \page{264} `good prose style'. On the other
...
\page{265}I have not here been considering the literary use of
