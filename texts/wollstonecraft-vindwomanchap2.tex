...
\settowidth\versewidth{\small Is Woman's \textit{happiest} knowledge and her \textit{praise}.'}
\begin{verse}[\versewidth]
\poke{`}To whom thus Eve with \textit{perfect beauty} adorn'd.\\
...
\settowidth\versewidth{\small Hast thou not made me here thy substitute,}
\begin{verse}[\versewidth]
\poke{`}Hast thou not made me here thy substitute,\\
...
contempla-\page{47}tion of the noble struggles of suffering merit has
...
\settowidth\versewidth{\small As when she touch'd the brink of all we hate.'}
\begin{verse}[\versewidth]
\poke{`}Yet ne'er so sure our passion to create,\\
...
% NOTE: 'it' after 'study?' is correct below
...
% NOTE: double quotes below are correct; verses above use single
% quotes

\settowidth\versewidth{\small The stars are more in fault than they.''}
\begin{verse}[\versewidth]
\poke{``}If weak women go astray,\\
...
not \page{72} clearer; and truth, as it is a simple principle, which
