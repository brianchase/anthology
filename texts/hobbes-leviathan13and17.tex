...
\authdate{1588--1679}
\textdate{1651}
\chapter[Thomas Hobbes -- Leviathan, chaps. 13 and
17]{Leviathan\\\smaller Chapters 13 and 17}

\nfootnote{\fullcite{hobbes1904}}

\page{81}\section*{\textsc{Chap}. XIII. Of the \textsc{Natruall
...
\page{86} placed in; though with a possibility to come out of it,
...
% Hack to get two of these insets in one paragraph:
...
\begin{wrapfigure}[4]{o}{0.2\textwidth}\raggedright Soveraigne, and
